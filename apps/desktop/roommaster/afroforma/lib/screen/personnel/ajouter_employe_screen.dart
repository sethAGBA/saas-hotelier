...
class AjouterEmployeScreen extends StatefulWidget {
  ...
  @override
  _AjouterEmployeScreenState createState() => _AjouterEmployeScreenState();
}

class _AjouterEmployeScreenState extends State<AjouterEmployeScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: false,
        // Use a dark background for readability, aligned with AppBarTheme
        ...
        bottom: PreferredSize(
          ...
          child: Container(
            // Keep the tab ribbon consistent with the AppBar background
  ...
  void _saveEmployee() {
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Employé enregistré avec succès (données en console)'),
          backgroundColor: Colors.green,
        ),
      );
      Navigator.of(context).pop();
