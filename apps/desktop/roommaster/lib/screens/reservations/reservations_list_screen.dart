...
class _ReservationsListScreenState extends State<ReservationsListScreen> {
  ...
  Future<List<Map<String, dynamic>>> _load() async {
    ...
    // Si JWT dispo, on tente l’API distante, sinon fallback SQLite locale
    if (auth.authToken != null && auth.tenantId != null) {
      ...
      try {
        ...
        // en cas d’erreur réseau/API, fallback local
      }
    }
    return LocalDatabase.instance.fetchReservations();
  }
