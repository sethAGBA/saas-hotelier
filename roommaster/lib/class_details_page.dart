...
//         ScaffoldMessenger.of(context).showSnackBar(
//           SnackBar(
//             content: const Text("Informations de l'établissement introuvables"),
//             backgroundColor: Theme.of(context).colorScheme.error,
//           ),
//         );
//         return;
...
//       final dirResult = await DirectoryHelper.pickDirectory(
//         dialogTitle: 'Choisissez un dossier de sauvegarde',
//       );
//       if (!dirResult.hasPath) {
//         if (dirResult.usedFallback && dirResult.errorMessage != null) {
//           ScaffoldMessenger.of(context).showSnackBar(
//             SnackBar(
//               content: Text(dirResult.errorMessage!),
//               backgroundColor: Theme.of(context).colorScheme.error,
//             ),
//           );
//         }
//         return;
//       }
//       final dirPath = dirResult.path!;

//       final now = DateTime.now();
//       final formattedDate =
//           '${now.day.toString().padLeft(2, '0')}-${now.month.toString().padLeft(2, '0')}-${now.year}';
//       final fileName = 'cartes_scolaires_${_nameController.text}_${formattedDate}.pdf';
//       final file = File('$dirPath/$fileName');
//       await file.writeAsBytes(pdfBytes);
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
//           content: Text('Cartes générées: ${file.path}'),
//           backgroundColor: Theme.of(context).colorScheme.primary,
//           action: SnackBarAction(
//             label: 'Ouvrir',
//             textColor: Colors.white,
