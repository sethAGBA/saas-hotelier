          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.login, color: _statusColor(status)),
              ),
          ...
          if (_isToday(checkIn)) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(10),
                border: Border.all(color: const Color(0xFF43e97b).withOpacity(0.5)),
              ),
              child: const Text(
                'Arrivée aujourd\'hui',
                style: TextStyle(
          ...
          Row(
            children: [
              ...
              ElevatedButton.icon(
                ...
                label: const Text('Confirmer check-in'),
              ),
            ],
          ),
        ],
